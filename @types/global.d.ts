...
declare module 'react-native-svg-uri-updated'
declare module "*.svg" {
...
declare interface WalletConnectSession {
	uri:			string
	name:			string
	url:			string
	description:	string
...
declare interface WalletConnectHistory {
	time:			number
	uri:			string
	name:			string
	url:			string
...
declare type StoreObjectKeyType = 'inited'|'lang'|'theme'|'browser'|'password'|'vault'|'networks'|'tokens'|'accounts'|'apps'|'currentNetwork'|'currentAccount'|'sessionId'|'createdAccountLayer'|'lastAccessTime'
...
declare interface StoreObject {
	...
	nfts:				{[chainKey: string]: NFTObject[]}
	...
	password:			string
	connects:			WalletConnectSession[]
	connectHistory:		WalletConnectHistory[]
}
